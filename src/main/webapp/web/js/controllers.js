...
angular.module('app.controllers', ['pascalprecht.translate', 'ngCookies'])
  .controller('AppCtrl', ['$scope', '$translate', '$localStorage', '$window', '$location',
    function(              $scope,   $translate,   $localStorage,   $window,$location ) {
      ...
      $scope.settingShow = function settingShow(){
          if($scope.app.settings.settingHidden==true){
            $scope.app.settings.settingHidden = false;
          }else if($scope.app.settings.settingHidden==false){
            $scope.app.settings.settingHidden = true;
          }
      }

      $scope.footerHide = function footerHide(){
