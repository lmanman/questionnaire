...
public class FileUtil {
	...
	public static com.visionet.letsdesk.app.common.file.File getFile() {
		return _file;
	}
...
//	}
	...
	public static void write(File file, InputStream is, int off) throws IOException{
		getFile().write(file, is, off);
	}

	public static void setFile(com.visionet.letsdesk.app.common.file.File file) {
		_file = file;
	}

	private static com.visionet.letsdesk.app.common.file.File _file = FileImpl.getInstance();
