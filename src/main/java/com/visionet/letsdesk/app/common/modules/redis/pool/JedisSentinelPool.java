package com.visionet.letsdesk.app.common.modules.redis.pool;
...
public class JedisSentinelPool extends Pool<Jedis> {
	...
	/**
	 * see {@link #JedisSentinelPool(ConnectionInfo[], String, ConnectionInfo, redis.clients.jedis.JedisPoolConfig)}
	 */
