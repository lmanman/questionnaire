...
//		System.out.println(path);
		...
		fileList.add(new File("C:/TEMP/letsdesk/a1.jpg"));
//		fileList.add(new File("C:/TEMP/letsdesk/a5.png"));
//		fileList.add(new File("C:/TEMP/letsdesk/a2.jpg"));
//		fileList.add(new File("C:/TEMP/letsdesk/a3.jpg"));
//		fileList.add(new File("C:/TEMP/letsdesk/a4.jpg"));
		System.out.println(ImageUtil.plus(null,new String[]{"C:/TEMP/letsdesk/xx2.jpg","xx2.jpg"}));
		*/
	}
}
