...
package com.visionet.letsdesk.app.common.modules.props;
...
public class PropsKeys {
    ...
    public static final String SMS_HTTP_ACCOUNT_BATCH = "sms.http.account.batch";
    public static final String SMS_HTTP_PASSWD_BATCH = "sms.http.passwd.batch";
